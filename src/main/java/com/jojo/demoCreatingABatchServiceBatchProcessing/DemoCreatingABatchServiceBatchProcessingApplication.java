package com.jojo.demoCreatingABatchServiceBatchProcessing;
 ...
 *    application... You package everything in a single, executable
 *    JAR file, driven by a good old Java main() method.
 */
 ...
 *      BUT WE USE @ENABLEAUTOCONFIGURATION
 *
 * @CompenentScan:
 *  - tells Spring to look for other components, configurations, and services
 *      in the "hello" package, allowing it to find the controllers
 */
@SpringBootApplication
public class DemoCreatingABatchServiceBatchProcessingApplication {

    /**
     * The "main()" method uses Spring Boot's "SpringApplication.run()" method
     *   to launch an application. Did you notice that there wasn't a single
     *   line of XML? No "web.xml" file either.
     *
	...
	public static void main(String[] args) throws Exception {
		SpringApplication.run(DemoCreatingABatchServiceBatchProcessingApplication.class, args);
	}

    /**
     * For demonstration purposes, there is code to create a JdbcTemplate,
     *   query the database, and print out the names of people the batch job
     *   inserts
     */
